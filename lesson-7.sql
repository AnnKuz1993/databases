...
insert into
	orders (user_id) 
values
	('1'), ('1'), ('2'), ('2'),('3'),('3'), ('3'),('3'), ('5'), ('5'), ('5'), ('1'), ('1'), ('1'), ('2'),('2'), ('1'), ('2'), ('1'), ('3'), ('3'), ('3'), ('1');
...
-- задание 1. Пользователи, которые осуществили хотя бы один заказ в интернет-магазине.
...
-- задание 2. спосок товаров с соответствующими разделами
...
-- задание 3. Список flights на русском 
